---
type: "Entrada"
title: "Una máquina propia para una web pequeña"
description: "Siempre me hizo gracia que en Shadowrun y Cyberpunk el ordenador no fuera invisible."
resource: "https://blog.impermanente.es/2026/05/05/una-mquina-propia-para-una.html"
tags: ["Herramientas"]
timestamp: "2026-05-05T12:31:12+02:00"
---

Siempre me hizo gracia que en [Shadowrun](https://www.shadowruntabletop.com/) y [Cyberpunk](https://rtalsoriangames.com/cyberpunk/) el ordenador no fuera invisible. Un deck no era una superficie lisa que te invitaba a tocar iconos bonitos. Era una herramienta. Pesaba, tenía puertos, cables, modificaciones, limitaciones. Era parte del personaje casi tanto como una chaqueta, una pistola o una deuda peligrosa.
...
Hace poco escuché a Nirav Patel, CEO de [Framework](https://frame.work/), en una [entrevista en Intelligent Machines](https://twit.tv/shows/intelligent-machines/episodes/868). La conversación giraba en torno a una idea incómoda: la computación personal está amenazada. Patel hablaba del riesgo de que el ordenador termine convertido en un terminal tonto, bloqueado, una ventana hacia el ordenador de otro en la nube, al que estamos suscritos. Su postura era sencilla y bastante radical en estos tiempos: si quieres ser dueño de tu ordenador, deberías poder serlo. Del hardware y del software. Incluso si la interfaz del futuro es una IA.
...
Por eso lo conecto tanto con la small web, con RSS y con la decisión de mantener este blog. Leer por RSS es una forma de decir que no quiero que un algoritmo decida toda mi dieta mental. Escribir en un blog propio es una forma de decir que mis textos no tienen que vivir siempre dentro de una plataforma que cambia de dueño, de política o de modelo de negocio cada seis meses. Usar formatos abiertos, como escribí en [Soberanía digital personal](/2026/02/28/soberana-digital-personal.html), es una forma muy poco espectacular de cuidar el acceso futuro a las propias ideas.

Un cyberdeck pertenece a esa familia de gestos. No porque sea necesario para leer RSS. No lo es. Mi lector de feeds funciona perfectamente en cualquier pantalla, y si estás leyendo esto desde RSS, como decía en [Blog rediseñado](/2026/04/06/blog-rediseado.html), probablemente ni te enteres de las reformas visuales del sitio. Pero el impulso es el mismo. Frente a una red cada vez más mediada por plataformas, recomendaciones automáticas y cajas negras, aparece el deseo de tener canales propios, archivos propios, máquinas propias.
...
[1] [Original en el blog](https://blog.impermanente.es/2026/05/05/una-mquina-propia-para-una.html)
